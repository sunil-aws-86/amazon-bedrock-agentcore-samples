...
from sre_agent.memory.tools import SavePreferenceTool, SaveInfrastructureTool, SaveInvestigationTool, RetrieveMemoryTool
from sre_agent.memory.client import SREMemoryClient
from sre_agent.memory.strategies import UserPreference, InfrastructureKnowledge, InvestigationSummary
...
class TestSaveInfrastructureTool:
    ...
    def test_save_infrastructure_success(self, save_infrastructure_tool, mock_client):
        ...
        with patch('sre_agent.memory.tools._save_infrastructure_knowledge') as mock_save:
            mock_save.return_value = True
...
class TestRetrieveMemoryTool:
    ...
    def test_retrieve_preferences_success(self, retrieve_tool, mock_client):
        ...
        with patch('sre_agent.memory.tools._retrieve_user_preferences') as mock_retrieve:
    ...
    def test_retrieve_infrastructure_knowledge(self, retrieve_tool, mock_client):
        ...
        with patch('sre_agent.memory.tools._retrieve_infrastructure_knowledge') as mock_retrieve:
            ...
            mock_retrieve.assert_called_once_with(mock_client, "sre-agent", "service dependencies")
    ...
    def test_retrieve_investigation_summaries(self, retrieve_tool, mock_client):
        ...
        with patch('sre_agent.memory.tools._retrieve_investigation_summaries') as mock_retrieve:
            ...
            mock_retrieve.assert_called_once_with(mock_client, "sre-agent", "service outage")
