...
class MemoryConfig(BaseModel):
    ...
    preferences_retention_days: int = Field(
        default=90,
        description="Days to retain user preferences"
    )
    infrastructure_retention_days: int = Field(
        default=30,
        description="Days to retain infrastructure knowledge"
    )
    ...
    auto_capture_preferences: bool = Field(
        default=True,
        description="Automatically capture user preferences"
    )
    auto_capture_infrastructure: bool = Field(
        default=True,
        description="Automatically capture infrastructure patterns"
    )
    auto_generate_summaries: bool = Field(
        default=True,
        description="Automatically generate investigation summaries"
    )
