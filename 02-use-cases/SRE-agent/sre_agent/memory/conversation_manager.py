...
class ConversationMemoryManager:
    ...
    def store_conversation_batch(
        ...
        try:
            ...
            if not session_id:
                raise ValueError("session_id is required for conversation batch storage")
            if not messages:
...
def create_conversation_memory_manager(memory_client: SREMemoryClient) -> ConversationMemoryManager:
